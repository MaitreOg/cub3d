...
void	raycast(t_data *data)
{
    ...
    {
        //printf("Hey x = %d\n", x);
        dir_ray = calc_dir_ray(x, data->dir_cam, data->plane_cam);
        wall = launch_ray(data->player, dir_ray, &side_dist, &side);
        //printf("Hey wall = %d\n", wall);
        ...
        create_img(to_draw, x, data, side_dist, side, data->mlx_ptr);
    }
